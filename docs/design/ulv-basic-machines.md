...
| 化学反应釜 | 超低压电动马达 ×1 + 红合金单线 ×2 + 铁板 ×2 + 玻璃 ×3 + ULV 机械方块 ×1（v0.8） |
| 流体固化器 | 超低压电动马达 ×1 + 红合金单线 ×2 + 铁板 ×4 + 钢板 ×1 + ULV 机械方块 ×1（v0.8） |
| 流体提取机 | 超低压电动马达 ×1 + 红合金单线 ×2 + 铁板 ×4 + 玻璃 ×1 + ULV 机械方块 ×1（v0.9） |
