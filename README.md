...
- **ULV 构件线**：电动马达（对齐上游：铜线圈 + 磁化铁杆）/ 电动活塞 + 传送带（2 件/t）/ 电动泵（16 mB/t）/ 机械臂（2 件/周期）覆盖板；**极化机**提供磁化铁杆的电力磁化路线（对照红石手工磁化）；
...
- **石油线**：油田泵抽取基岩油田 → 原始蒸馏塔（3×6×3 无电分馏）→ 原始裂化机（乙烯）→ 聚乙烯，为 LV 时代储备塑料与燃料。
